...
<head>
    ...
    <link rel="stylesheet" href="/homepage/css/venobox.css" />
 ...
 <![endif]-->
    ...
    <!-- Global site tag (gtag.js) - Google Analytics -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-061D9CGF60"></script>
    <script>
        window.dataLayer = window.dataLayer || [];
...
<body>
    <!-- START - TICKER WIDGET -->
    <div
        style="height:39px; background-color: #1D2330; overflow:hidden; box-sizing: border-box; border: 1px solid #282E3B; border-radius: 4px; text-align: right; line-height:14px; block-size:39px; font-size: 12px; font-feature-settings: normal; text-size-adjust: 100%; box-shadow: inset 0 -20px 0 0 #262B38;padding:1px;padding: 0px; margin: 0px; width: 100%;">
                    ...
                    <nav id="main_menu" class="navbar-right">
                        ...
                        <div id="navbar" class="navbar-collapse collapse">
                            <ul id="nav" class="nav navbar-nav">
                                ...
                                <li class="dropdown">
                                    <a class="dropdown-toggle" data-toggle="dropdown" href="javascript:;">About Us
                                        <span class="caret"></span></a>
                                    <ul class="dropdown-menu">
                                        <li><a href="{{ route('home') }}#about_area">About OWB</a></li>
                                    </ul>
                                </li>
                                <li><a href="{{ route('home') }}#about_area">Services</a></li>
                                <li class="dropdown">
    ...
    <!-- WhatsHelp.io widget -->
    <script src="static.elfsight.com/platform/platform.html" defer></script>
    <div class="elfsight-app-dcd2c43c-4d95-4aef-84fa-2ee7139e8530"></div>
    ...
    <script src="/homepage/js/jquery.easing.1.3.min.js"></script>
    <script src="/homepage/js/jquery.mixitup.js"></script>
    <script src="/homepage/js/waypoints.min.js"></script>
    <script src="/homepage/js/jquery.counterup.min.js"></script>
    <script src="/homepage/js/scrollup.js"></script>
    <script src="/homepage/js/tilt.js"></script>
    <script src="/homepage/js/wow.min.js"></script>
    <script src="/homepage/js/venobox.min.js"></script>
