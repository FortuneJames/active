<x-guest-layout>
    ...
    <!-- choose us Area -->
    <section class="why-chooseus section_gray">
        <div class="container">
            <div class="row ">
                <div class="col-md-5 col-sm-6 col-xs-12">
                    <div class="image display-block-image">
                        <br><br><img alt="" src="/homepage/img/globe-economy-2.jpg">
                    </div>
                </div>
    ...
    <section id="about_area" class="section_padding feature-section section_gray">
        <br><br><br>
    ...
    <section id="about_area" class="section_padding feature-section">
        <br><br><br>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 col-xs-12 text-left wow fadeIn" data-wow-delay=".1s">
                    <div class="section_title">
                        <h2>About Interactive Achivers<br>
                            <br>
                        </h2>
                        <p>
                ...
                <div class="row">
                    <div class="col-sm-5">
                        ...
                        <div class="single_contact_info">
                            <i class="ti-world"></i>
                            <p>
                                <a href="mailto:info@nteractiveachivers.com">info@Interactiveachivers.com</a><br />
                                <a href="index.html">https://Interactivechivers.com</a>
                            </p>
                        </div>
                        <div class="single_contact_info">
